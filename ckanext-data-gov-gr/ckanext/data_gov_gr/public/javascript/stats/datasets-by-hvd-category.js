document.addEventListener('DOMContentLoaded', function() {
    const chartContainer = document.getElementById('hvd-pie-chart');
    if (!chartContainer) return;
    const chart = echarts.init(chartContainer);

    const table = document.querySelector('#stats-datasets-per-hvd table');
    if (!table) return;
    ...
    const toggleBtn = document.getElementById('toggleHvdView');
    const tableView = document.getElementById('hvd-table-view');
    let showingPie = true;
