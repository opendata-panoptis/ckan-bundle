document.addEventListener('DOMContentLoaded', function() {
    const chartContainer = document.getElementById('largest-groups-bar-chart');
    const table = document.querySelector('#stats-largest-groups table');
    const toggleBtn = document.getElementById('toggleLargestGroupsView');
    const tableView = document.getElementById('largest-groups-table-view');
    ...
    function checkVisibility() {
        ...
        const isSectionActive = hash === '#stats-largest-groups' || path.includes('/stats/largest-groups');
