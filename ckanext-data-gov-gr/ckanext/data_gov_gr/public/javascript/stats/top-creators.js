document.addEventListener('DOMContentLoaded', function() {
    const chartContainer = document.getElementById('top-creators-bar-chart');
    const table = document.querySelector('#stats-most-create table');
    const toggleBtn = document.getElementById('toggleTopCreatorsView');
    const tableView = document.getElementById('top-creators-table-view');
    ...
    function checkVisibility() {
        ...
        const isSectionActive = hash === '#stats-most-create' || path.includes('/stats/top-creators');
