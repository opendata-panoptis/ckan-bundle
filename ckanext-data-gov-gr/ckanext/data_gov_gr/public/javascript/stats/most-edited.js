document.addEventListener('DOMContentLoaded', function() {
    const chartContainer = document.getElementById('most-edited-bar-chart');
    const table = document.querySelector('#stats-most-edited table');
    const toggleBtn = document.getElementById('toggleMostEditedView');
    const tableView = document.getElementById('most-edited-table-view');
    ...
    function checkVisibility() {
        ...
        const isSectionActive = hash === '#stats-most-edited' || path.includes('/stats/most-edited');
