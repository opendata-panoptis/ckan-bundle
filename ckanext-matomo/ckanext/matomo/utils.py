...
# Set end_date explicitly to be the end of the current day (23:59:59.999999),
# and start_date to be at 00:00:00 for a full duration of 7, 30, or 365 days ago, respectively.
# Example on 2023-03-21 14:11:42:
# week  = 2023-03-15 00:00:00 - 2023-03-21 23:59:59
# month = 2023-02-20 00:00:00 - 2023-03-21 23:59:59
# year  = 2022-03-22 00:00:00 - 2023-03-21 23:59:59
#
# This ensures that recent data (including today) is included in stats like
...
def last_week() -> Tuple[datetime, datetime]:
    ...
    start_date: datetime = today - relativedelta(days=6)
