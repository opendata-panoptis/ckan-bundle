...
class MatomoAPI(object):
    ...
    def resource_download_statistics(self, period='month', date='today', dataset=None) -> Dict[str, Any]:
        pattern = r'[^/]*/(data/)?([^/]+/)?dataset/[^/]+/resource/[^/]+/download/[^/]+$'
        if dataset:
            pattern = r'[^/]*/(data/)?([^/]+/)?dataset/[^/]+/resource/[^/]+/download/[^/]+$'.format(dataset=dataset)
    ...
    def dataset_page_statistics(self, period='month', date='today', dataset=None) -> Dict[str, Any]:
        ...
        pattern = r'[^/]*/(data/)?([^/]+/)?dataset/[^/]+$'
        if dataset:
            pattern = r'[^/]*/(data/)?([^/]+/)?dataset/[^/]+$'.format(dataset=dataset)
    ...
    def resource_page_statistics(self, period='month', date='today', dataset=None) -> Dict[str, Any]:
        pattern = r'[^/]*/(data/)?([^/]+/)?dataset/[^/]+/resource/[^/]+$'
        if dataset:
            pattern = r'[^/]*/(data/)?([^/]+/)?dataset/[^/]+/resource/[^/]+$'.format(dataset=dataset)
